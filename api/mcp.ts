...
function requireGoogleAccounts() {
  ...
  if (!accounts.length) {
    throw new Error(
      'Missing Google OAuth credentials. Connect the pro or personal account using GOOGLECLIENTID_PRO/GOOGLECLIENTSECRET_PRO/GOOGLEREFRESHTOKEN_PRO or GOOGLECLIENTID_PERSONAL/GOOGLECLIENTSECRET_PERSONAL/GOOGLEREFRESHTOKEN_PERSONAL, or the underscore variants GOOGLE_CLIENT_ID_PRO/GOOGLE_CLIENT_SECRET_PRO/GOOGLE_REFRESH_TOKEN_PRO and GOOGLE_CLIENT_ID_PERSONAL/GOOGLE_CLIENT_SECRET_PERSONAL/GOOGLE_REFRESH_TOKEN_PERSONAL.',
    );
  }
  return accounts;
}
